...
@SimpleObject
@UsesLibraries(libraries = "material.jar,"+"material.aar,"+"androidx-cardview.jar,"+"androidx-cardview.aar,"+"androidx-appcompat.jar,"+"androidx-appcompat.aar,"
    +"viewpager2.jar,"+"viewpager2.aar,"+"androidx-recyclerview.jar,"+"androidx-recyclerview.aar,"+"androidx-core.jar,"+"androidx-core.aar,"+"androidx-collection.jar,"
    +"androidx-appcompat-resources.jar,"+"androidx-appcompat-resources.aar,"+"androidx-vector-drawable.jar,"+"androidx-vector-drawable.aar,"+"androidx-viewpager.jar,"
    +"androidx-viewpager.aar,"+"androidx-interpolator.jar,"+"androidx-interpolator.aar,"+"androidx-customview.jar,"+"androidx-customview.aar")
